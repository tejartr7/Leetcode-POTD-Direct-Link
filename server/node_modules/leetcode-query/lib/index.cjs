...
async function get_csrf() {
  const cookies_raw = await (0, import_cross_fetch.default)(BASE_URL, {
    headers: {
...
var LeetCode = class extends import_eventemitter32.default {
  ...
  async submission(id) {
    ...
    try {
      ...
      const res = await (0, import_cross_fetch2.default)(`${BASE_URL}/submissions/detail/${id}/`, {
        headers: {
          origin: BASE_URL,
          referer: BASE_URL,
  ...
  async graphql(query) {
    ...
    try {
      await this.limiter.lock();
      const BASE = BASE_URL;
      const res = await (0, import_cross_fetch2.default)(`${BASE}/graphql`, {
        method: "POST",
        headers: {
...
async function get_csrf2() {
  const res = await (0, import_cross_fetch3.default)(`${BASE_URL_CN}/graphql/`, {
    method: "POST",
    headers: {
      "content-type": "application/json",
      "user-agent": USER_AGENT
...
var LeetCodeCN = class extends import_eventemitter33.default {
  ...
  async graphql(query, endpoint = "/graphql/") {
    ...
    try {
      ...
      const res = await (0, import_cross_fetch4.default)(`${BASE}${endpoint}`, {
        method: "POST",
        headers: {
          "content-type": "application/json",
          origin: BASE,
